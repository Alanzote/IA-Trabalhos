...
// Classe para o Trabalho 03.
public static class Trabalho03 {

    // Cria o Grafo base. Usado também no trabalho 04.
    public static Graph CreateGraph(out List<Node> Nodes) {
        ...
        // Criar Lista de Nós.
        Nodes = new List<Node> { N0, N1, N2, N3, N4, N5, N6, N7 };
    ...
    public static void Main(String[] args) {
        // Cria o Grafo.
        Graph GN = CreateGraph(out List<Node> Nodes);
